...
u(document).on("click",".expand ul.occurances li",function(e){var ref=u(this).find("strong").text();getVerse(ref);clearLexicon();});u(document).on("click",".mark-helpful",function(){var index_id=u(this).attr("data-id");console.log(index_id);fetch("/resources/helpful/"+index_id);u(this).closest(".panel-footer").html("<small>Thanks! We may rank this resource higher next time.</small>");});u(document).on("click",".mark-unhelpful",function(){var index_id=u(this).attr("data-id");fetch("/resources/unhelpful/"+index_id);u(this).closest(".panel-footer").html("<small>Good to know, we may put this resource further down the list.</small>");});function closeMenu(){u(".history-list").removeClass("open");u(".overlay.menu").addClass("hidden");u("#menu").removeClass("show");}
