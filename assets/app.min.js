...
u("#menu .history").on("click",function(){u("#menu .history-list").toggleClass("open");});u(".nav-item").on("click",function(){u(this).find("ul").first().style.display="block";});document.addEventListener("mouseup",function(event){if(event.target.closest("#lexicon"))return;if(event.target.closest(".history-list"))return;clearLexicon();u(".dropdown-menu.history-list").first().style.display="none";});